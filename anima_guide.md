...
<body>
	...
	<div class="card">
		<div class="card-body">
			...
			<p>Starting NPC:	Rowena
			<p>Starting Location:	Dravania, Idyllshire (x5.7,y5.5)
			<p>You only have to do this once, if you do multiple anima weapons you can skip this step.
		</div>
	</div>
	<div class="card">
		<div class="card-body">
			<h5 class="card-title">Step 2. Soul Without Life</h5>
			<p>Starting NPC:	Ardashir
			<p>Starting Location:	Alpha Quadrant, Azys Lla (x7,y11)
			<p> Syndony in Mor Dhona (x22,y5) will trade luminous crystals for Astral Nodule and Umbral Nodule.
			<div>Farm Heavensward Fates for luminous Crystals
				<table class="table">
				...
				<p>Crystals can drop from any Fate in the zone regardless of level, but you must get a gold rating in the Fate to have a chance for the crystal to drop.
				<p>You need one of each type to complete this phase. You can gather multiples of each if you plan on completing multiple animas. They will stay in your inventory until you use them or get rid of the extras.
			</div>
		</div>
	</div>
	<div class="card">
		<div class="card-body">
			...
			<p>Starting NPC:	Ardashir
			<p>Starting Location:	Alpha Quadrant, Azys Lla (x7,y11)
			<p> This stage requires you to complete 10 dungeons in the specified order. They can be run unsynced and this stage goes fairly quick.
			<ol>
				<li>Snowcloak</li>
				<li>Sastasha (Hard)</li>
	...
	<div class="card">
		<div class="card-body">
			...
			<p>Starting NPC:	Ardashir
			<p>Starting Location:	Alpha Quadrant, Azys Lla (x7,y11)
			<p>This stage requires you to trade for four items from Cristiana in Mor Dhona.
			<table class="table">
			...
			<p>The Unidentifiable Bone/Shell/Ore/Seeds can be obtained multiple ways.
			<ul>
			...
			<p>The second token can be obtained either via crafting or using Grand Company seals. Using GC seals, each token costs 5K seals, for a total of 80K seals.
		</div>
	</div>
	<div class="card">
		<div class="card-body">
			...
			<p>Starting NPC:	Ardashir
			<p>Starting Location:	Alpha Quadrant, Azys Lla (x7,y11)
			<p>This stage requires you to trade 5xAether Oil to Ardashir.
			<p>Aether Oil can be obtained two ways:
			<ol>
	...
	<div class="card">
		<div class="card-body">
			...
			<p>Starting NPC:	Ardashir
			<p>Starting Location:	Alpha Quadrant, Azys Lla (x7,y11)
			<p>The goal of this stage is to trade for Crystal Sand from Ulan in Idyllshire. To purchase you can use any of these options:
			<table class="table">
			...
			<p>You will need between 60 and 80 Crystal Sands to complete this stage. For each Crystal Sand you will also need one Umbrite, which can be obtained from Hismena in Idyllshire for 75 poetics.
			<p>For each Crystal Sand and Umbrite, you will allocate stats to your anima as you see fit. Since we're using this for glamour and not for its combat ability, the stats aren't really relevant to the finished product.
		</div>
	</div>
	<div class="card">
		<div class="card-body">
	...
	<div class="card">
		<div class="card-body">
			...
			<p>Complete the following dungeons:
			<ol>
				<li>Sohm Al (Hard)
	...
	<div class="card">
		<div class="card-body">
			...
			<p>All Heavensward Fates/Dungeons/Trials give some light. In total, you will need to gather 2000 units of light. The game does not tell you specifically how much light you have gathered except through the Enhanced Anima Glass which has ten runes each representing 200 units of light. A rune will begin flashing as you fill it with light and then become solid when you have completely filled it.
			<p>The fastest method of farming light is A1S. You should not need more than 3-5 people to complete a run of this in 1-2 minutes. Each run will give you a "robust" amount of light (24 units).
			<p>This means each rune will take 8-9 runs of A1S to fill, and should be complete within 2-3 hours if the group can maintain a good pace. In total it is necessary to run A1S 84 times to complete the light farming process.
			<p>When complete, speak to the Verification Node in Azys Lla to end this phase.
		</div>
	</div>
	<div class="card">
		<div class="card-body">
			<h5 class="card-title">Step 10. Some Assembly Required</h5>
			<p>For this stage you need to acquire 15 pneumite. These can be purchased from Hismena in Idyllshire or Auriana in Mor Dhona for 100 poetics each, or from your Grand Company at 4K seals each.
		</div>
	</div>
	<div class="card">
		<div class="card-body">
			<h5 class="card-title">Step 11. Best Friends Forever</h5>
			<p>Complete the following trials:
			<ol>
			...
			<p>After completing these trials, purchase Archaic Enchanted Ink for 500 poetics from Hismena in Idyllshire or Auriana in Mor Dhona.
		</div>
	</div>
</body>
</html>